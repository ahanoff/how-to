...
WORKDIR /src
COPY ["LambdaASP.NETCoreWebAPI4.csproj", "LambdaASP.NETCoreWebAPI4/"]
RUN dotnet restore "LambdaASP.NETCoreWebAPI4/LambdaASP.NETCoreWebAPI4.csproj"

WORKDIR "/src/LambdaASP.NETCoreWebAPI4"
COPY . .
RUN dotnet build "LambdaASP.NETCoreWebAPI4.csproj" --configuration Release --output /app/build

FROM build AS publish
RUN dotnet publish "LambdaASP.NETCoreWebAPI4.csproj" \
...
Execute unit tests
```
    cd "LambdaASP.NETCoreWebAPI4/test/LambdaASP.NETCoreWebAPI4.Tests"
    dotnet test
```

Deploy application
```
    cd "LambdaASP.NETCoreWebAPI4/src/LambdaASP.NETCoreWebAPI4"
