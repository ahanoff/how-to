...
WORKDIR /src
COPY ["LambdaEmptyFunction1.csproj", "LambdaEmptyFunction1/"]
RUN dotnet restore "LambdaEmptyFunction1/LambdaEmptyFunction1.csproj"

WORKDIR "/src/LambdaEmptyFunction1"
COPY . .
RUN dotnet build "LambdaEmptyFunction1.csproj" --configuration Release --output /app/build

FROM build AS publish
RUN dotnet publish "LambdaEmptyFunction1.csproj" \
